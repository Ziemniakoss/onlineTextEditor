...
// use actix_web::{middleware, web, web::{get, post, resource}, App, HttpResponse, HttpServer, Result, HttpRequest};
// use rand::Rng;
...
// }
//
// async fn do_something(session: Session, req:HttpRequest) -> Result<HttpResponse> {
// 	println!("do {:#?}", req);
//
// 	let user_id: Option<String> = session.get::<String>("user_id").unwrap();
// 	let counter: i32 = session
...
// }
//
// async fn login(user_id: web::Json<Identity>, session: Session, req: HttpRequest) -> Result<HttpResponse> {
// 	println!("login {:#?}", req);
//
...
// }
//
// async fn logout(session: Session, req: HttpRequest) -> Result<HttpResponse> {
// 	println!("{:#?}", req);
...
// 	use actix_web::{middleware, test, web::{get, post, resource}, App};
// 	use serde_json::json;
//
// 	#[actix_rt::test]
